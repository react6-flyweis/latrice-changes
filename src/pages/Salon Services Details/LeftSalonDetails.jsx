  ...
  return (
    <>
      ...
      <SalonDetailsMakepayment
        ...
        handleopentforthmodal={handleopentforthmodal}
      ...
      <div className=''>
        <div className="flex items-center justify-center gap-3 mb-5">
          <button className="w-full bg-[#FFE6D8] text-[#FF827F] font-[700] font-sansation sm:text-[20px] text-[15px] px-2 py-4  rounded-[10px] shadow-[0px_4px_4px_0px_#00000040]"
            onClick={() => setModalOpen(true)}
          >
            Book Now
          </button>
          <button className="w-full bg-[#D9D9D9] text-[#2F2F2F] font-[700] font-sansation sm:text-[20px] text-[15px] px-2 py-4  rounded-[10px] shadow-[0px_4px_4px_0px_#00000040]"
        ...
        <div className='flex items-center justify-between mb-5'>
          <h6 className='text-charcoal font-rasa sm:text-[30px] text-[20px] font-[600]'>Top Services</h6>
          <div className='bg-[#FAF9F6] border border-[#2F2F2F33] h-[40px] rounded-[10px] flex items-center px-2 w-[60%]'>
            <input type="search" placeholder='Search for a service.. ' className='flex-1 outline-none' />
            <IoMdSearch />
          </div>
        </div>
            ...
            <div key={idx} className="border border-[#2F2F2F33] rounded-[10px] p-2 mb-2">
              <div className="flex items-center justify-between">
                <div className="w-[60%]">
                  ...
                  <p className="text-[12px] text-[#494948] font-inter font-[400] mb-2">{service.description}</p>
        ...
        <div className='space-y-2 mb-5'>
          <h2 className="font-rasa font-[600] text-[30px] text-charcoal">Services</h2>
          <div className='bg-[#FAF9F6] shadow-[0px_0px_4px_0px_#00000040] rounded-[10px] px-3 py-2'>
            {services1.map((service, idx) => (
              <div key={idx} className="border border-[#2F2F2F33] rounded-[10px] p-2 mb-2">
                <div className="flex items-center justify-between">
                  <div className="w-[60%]">
                    <h3 className="font-[700] text-[14px] font-gotu text-[#121111] mb-1.5">{service.title}</h3>
        ...
        <div className='space-y-2 mb-5'>
          <h2 className="font-rasa font-[600] text-[30px] text-charcoal">Haircuts</h2>
          <div className='bg-[#FAF9F6] shadow-[0px_0px_4px_0px_#00000040] rounded-[10px] px-3 py-2'>
            {services.map((service, idx) => (
              <div key={idx} className="border border-[#2F2F2F33] rounded-[10px] p-2 mb-2">
                <div className="flex items-center justify-between">
        ...
        <div className='space-y-2 mb-5'>
          <h2 className="font-rasa font-[600] text-[30px] text-charcoal">Beard Care</h2>
          <div className='bg-[#FAF9F6] shadow-[0px_0px_4px_0px_#00000040] rounded-[10px] px-3 py-2'>
            {services.map((service, idx) => (
              <div key={idx} className="border border-[#2F2F2F33] rounded-[10px] p-2 mb-2">
                <div className="flex items-center justify-between">
        ...
        <div className='space-y-2 mb-5'>
          <h2 className="font-rasa font-[600] text-[30px] text-charcoal">Specialty Services</h2>
          <div className='bg-[#FAF9F6] shadow-[0px_0px_4px_0px_#00000040] rounded-[10px] px-3 py-2'>
            {services.map((service, idx) => (
              <div key={idx} className="border border-[#2F2F2F33] rounded-[10px] p-2 mb-2">
                <div className="flex items-center justify-between">
        ...
        <div className='space-y-1 mb-5'>
          <h2 className="font-rasa font-[600] text-[30px] text-charcoal">Amenities</h2>
          <div className='bg-[#FAF9F6] shadow-[0px_0px_4px_0px_#00000040] rounded-[10px] px-3 py-2'>
        ...
        <div className='space-y-2 mb-5'>
          <h2 className="font-rasa font-[600] text-[30px] text-charcoal">Ratings & Reviews</h2>
          <div className='bg-[#FAF9F6] shadow-[0px_0px_4px_0px_#00000040] rounded-[10px] px-3 py-2'>
            <div className="">
              <div className="flex items-center gap-2 mb-2">
                <div
                  className={`px-8 py-2 sm:text-[20px] text-[15px] font-[600] font-rasa rounded-[10px] flex items-center justify-center  cursor-pointer  ${activeTab === 'Client Reviews' ? 'bg-[#123E41] text-[#FAF9F6] border border-[#FAF9F6]' : ' text-[#2F2F2F]'
                    }`}
