    ...
    return (
        ...
        >
            ...
            <SalonDetailsMakepayment
                ...
                handleopentforthmodal={handlopenfivth}
            />
            ...
            <SalonsLinstModal
                ...
                handleOpenCreatenewappoitmentsuccess={handleOpenCreatenewappoitmentsuccess}
            />
            <CreatedNewAppointmentSuccessModal
                                    ...
                                    <tr key={rowIndex}>
                                        ...
                                        {dates.map((date, colIndex) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    {appointment ? (
                                                        <div className="p-2 h-full cursor-pointer" style={{ borderLeft: `4px solid ${borderColor}` }} onClick={() => handleOpenBookingdetails(appointment.modalstatus)}>
