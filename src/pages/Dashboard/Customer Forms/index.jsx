...
import { AppointmentFormModal, BookingCalendarModal, SalonDetailsMakepayment, SalonDetailsPaymenSuccessModal, SalonDetailsReviewandConfirm, ViewDetailsPersonalViewModal, WaitingBookingFormModal } from '../../../components/Modals/Modal';
...
const CustomerForms = () => {
    ...
    return (
        <ClientDashboardLayout title="Customer Forms"
            gpnumber='2'
            titleAction={
        ...
        >
            ...
            {iscustomercard ?
                <div className='grid grid-cols-2 gap-5 mt-2'>
                    {data.forms.map((form) => (
                        <FormsCards key={form.id} data={form} isPending showmodal={() => setModalOpen(true)} />
                    ))}
                </div>
                :
