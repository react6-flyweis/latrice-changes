...
export default function BusinessOwnerAccountSettingPage() {
    ...
    const renderCheckboxDays = (label, key, index) => (
        <label className="flex items-center sm:gap-5 justify-between" key={key}>
            ...
            <div
                className={`w-[28px] h-[28px] rounded-sm flex items-center justify-center transition-colors duration-300
      ${timeRanges[index].days[key] ? 'bg-primary' : 'bg-[#D9D9D9] border border-[#2F2F2F]'}`}
            >
    ...
    return (
        <BusinessOwnerDashboardLayout title="Account Settings"
            headerAction={
                <div className='flex items-center gap-2'>
            ...
            <div className="accountsetting-container">
                ...
                <div className="mb-4">
                    <div className="flex flex-col space-y-5">
                        ...
                        {renderSlider('Do you accept custom style requests?', 'washHair', IoGitPullRequestSharp, true)}
                        {renderSlider('Do you accept same-day appointments for each  service?', 'blowDryHair', LiaUserClockSolid, true)}
                    ...
                    <div className="mb-4">
                        {timeRanges.map((range, index) => (
                            <div key={range.id} className="mb-5">
                                ...
                                {index === 1 && (
                                    <div className="flex items-center gap-1.5 cursor-pointer" onClick={() => removeTimeRange(index)}>
                        ...
                        <div className="flex items-center gap-1.5 cursor-pointer" onClick={addTimeRange}>
                ...
                <div className="mb-5">
                    ...
                    <div className='flex items-center gap-10 mt-3'>
                        <div className="flex items-center gap-5">
                            <span className="text-[20px] font-bold font-sansation text-charcoal">Email</span>
                        ...
                        <div className="flex items-center gap-5 ">
                            <span className="text-[20px] font-bold font-sansation text-charcoal">Phone Number</span>
                ...
                <div className="mb-2">
                    ...
                    <label className="block sm:text-[20px] text-[15px] font-bold font-sansation text-charcoal mb-2">INVITE YOUR FRIENDS AND EARN REWARDS!</label>
                </div>
                {/* Invitation Link */}
                <div className="mb-2">
