...
import { BussinessBookingDetailsModal, BussinessChangeBookingDateTimeMOdal, BussinessResheduleSuccessModal } from '../../../components/Modals/Modal';
                        ...
                        <table className="w-full border-collapse">
                            <thead className="">
                                <tr className="bg-[#123E41]">
                                    <th className="font-[700] font-rasa sm:text-[18px] text-[15px] text-[#FAF9F6] p-2 rounded-tl-2xl">CLIENT PHOTO</th>
                                    <th className="font-[700] font-rasa sm:text-[18px] text-[15px] text-[#FAF9F6] p-2">Client NAME</th>
                                    ...
                                    <th className="font-[700] font-rasa sm:text-[18px] text-[15px] text-[#FAF9F6] p-2">PRICE</th>
                                    <th className="font-[700] font-rasa sm:text-[18px] text-[15px] text-[#FAF9F6] p-2 rounded-tr-2xl">STAFF</th>
                                </tr>
                            </thead>
                            <tbody>
                                {data.map((item, idx) => (
                                    <tr key={idx} className="bg-white">
                                        ...
                                        <td className="font-[700] font-rasa sm:text-[17px] text-[15px] text-[#464646] text-center border border-[#A8A8A84D]">{item.staff}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
