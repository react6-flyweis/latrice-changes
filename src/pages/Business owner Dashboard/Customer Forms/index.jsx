...
import { PreAppointmentFormModal, SendWaiverModal, SendWaiverConfirmModal, ViewDetailsWaiverModal, ViewDetailsPersonalViewModal, AppointmentFormModal } from '../../../components/Modals/Modal';
...
const BusinessCustomerForms = () => {
    ...
    return (
        <BusinessOwnerDashboardLayout title="Customer Forms"
            gpnumber='2'
            titleAction={
        ...
        >
            ...
            <div className="w-full mt-2">
                ...
                <div className="flex w-full bg-[#D9D9D9] rounded-[80px] overflow-hidden mb-2 p-1 max-w-4xl h-[60px]">
                    <button
                        className={`flex-1 py-2 sm:text-[30px] text-[20px] font-[500] font-rasa rounded-[80px]  ${activeTab === 'Your Clients' ? 'bg-white text-charcoal' : 'text-[#2F2F2F80]'
                            }`}
                    ...
                    <button
                        className={`flex-1 py-2 sm:text-[30px] text-[20px] font-[500] font-rasa rounded-[80px]  ${activeTab === 'Personal View' ? 'bg-white text-charcoal' : 'text-[#2F2F2F80]'
                            }`}
                ...
                {activeTab === 'Your Clients' ? (
                    ...
                    iscustomercard ?
                        <div className="">
                            <h2 className="sm:text-[30px] text-[20px] font-[600] text-charcoal font-rasa">Client Name</h2>
                        ...
                        <div className=' max-w-md border border-[#2F2F2F80] shadow-[0px_4px_4px_0px_#00000040] bg-white rounded-[40px] px-10 py-8 flex flex-col items-center justify-center gap-2'>
                            <img src={img1} alt="" />
                            <h6 className='sm:text-[30px] text-[20px] font-[600] text-charcoal font-rasa'>No Forms or<br /> Waivers Sent Yet</h6>
                            <p className='sm:text-[18px] text-[15px] font-[500] text-charcoal text-center font-rasa'>You’ll be able to send pre- appointment forms and
                                and waivers to clients once they’ve booked a service with you.</p>
                            <p className='sm:text-[18px] text-[15px] font-[500] text-charcoal text-center font-rasa'>Use forms to gather preferences and service related details. Use waivers to cover important agreements like liability or media consent.</p>
                    ...
                    iscustomercard ?
                        ...
                        <div className=' max-w-md border border-[#2F2F2F80] shadow-[0px_4px_4px_0px_#00000040] bg-white rounded-[40px] px-10 py-8 flex flex-col items-center justify-center gap-2'>
                            <img src={img} alt="" />
                            <h6 className='sm:text-[30px] text-[20px] font-[600] text-charcoal font-rasa'>No Forms or<br /> Waivers Sent Yet</h6>
                            <p className='sm:text-[18px] text-[15px] font-[500] text-charcoal text-center font-rasa'>When you book services with other professionals on Latrice, any required forms or waivers will appear here.</p>
                            <p className='sm:text-[18px] text-[15px] font-[500] text-charcoal text-center font-rasa'>You’ll be able to responds to there questions or sing waivers before you session.</p>
