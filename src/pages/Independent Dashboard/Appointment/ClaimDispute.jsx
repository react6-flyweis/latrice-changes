...
export default function IndependentClaimDispute() {
    ...
    return (
        ...
        <IndependentDashboardLayout title="Appointment Scheduling"
            gpnumber="8"
            titleAction={
            ...
            <div className="flex flex-col lg:flex-row w-full gap-4 mt-4">
                <div className="flex-1 overflow-auto">
                    ...
                    <div className="flex flex-wrap w-full overflow-hidden justify-center sm:justify-between gap-2 sm:gap-1 mb-3">
                        {['Current bookings', 'Upcoming bookings', 'Past bookings', 'Claim/Dispute'].map((item, index) => (
                    ...
                    <div className="min-h-screen mt-5 bg-[#FFFFFF] shadow-[0px_8.81px_52.86px_0px_#0000001A] w-full m-auto px-3 py-3 space-y-4">
                        <h6 className="font-rasa font-[700] sm:text-[18px] text-[15px] text-[#2F2F2F] leading-[18.95px] tracking-[0.018em] align-middle uppercase">Report any service issue so our support team can review the details and work toward a quick resolution.</h6>
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <h6 className="font-rasa font-bold text-[16px] sm:text-[18px] text-[#121111] leading-[18px] flex items-center gap-1">
                                        ...
                                        <FaPlus
                                            ...
                                            className={`cursor-pointer transform transition-transform duration-300 ease-in-out ${isOpen ? "rotate-180" : "rotate-0"
                                                }`}
                                        />
                                    </h6>
                                </div>
                            ...
                            {showflaghistory &&
                                <div className="flex justify-between items-center  m:w-[70%] w-full pt-2">
                                    <ul className="list-disc pl-5">
                                        <li className='font-rasa font-bold text-[16px] sm:text-[18px] text-[#121111] leading-[18px] align-middle'>Mar 21, 2025</li>
                                    </ul>
                                ...
                                <div className="px-4">
                                    <div className="flex gap-3 mb-2 pt-4">
                                        ...
                                        <div className='space-y-0.5'>
                                            <p className="font-[600] sm:text-[18px] text-[15px] text-[#121111]">Late Cancel by Provider - Ongoing</p>
                                            <p className="font-[600] sm:text-[18px] text-[15px] text-[#121111]">
                                                Client: Jasmine M.
                                            </p>
                                            <p className="font-[600] sm:text-[18px] text-[15px] text-[#121111]">Apr 10, 2025 - 1:00 PM</p>
                                            <p className="font-[600] sm:text-[18px] text-[15px] text-[#121111]">Loc Retwist - $70</p>
                                            <p className="font-[600] sm:text-[18px] text-[15px] text-[#121111]">Under Review by Latrice Team</p>
