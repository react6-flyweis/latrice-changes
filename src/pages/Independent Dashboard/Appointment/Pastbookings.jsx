...
import { BussinessPastBookingDetailsModal, BussinessPastBookingReviewModal, PastBookingReviewSuccessModal } from '../../../components/Modals/Modal';
                    ...
                    <div className="flex flex-wrap w-full overflow-hidden justify-center sm:justify-between gap-2 sm:gap-1 mb-3">
                        {['Current bookings', 'Upcoming bookings', 'Past bookings', 'Claim/Dispute'].map((item, index) => (
                            <Link key={index} to={routeMapping[item]}>
                                <button
                                    className={`p-2 sm:px-6 text-[16px] sm:text-[20px] font-medium font-rasa rounded-[10px] border transition-all duration-200 ${item === 'Past bookings'
                                        ? 'bg-[#123E41] text-[#FAF9F6] border-2 border-[#FAF9F6]'
                                        : 'text-[#2F2F2F] border-2 border-[#2F2F2F]'
                                        }`}
                                    style={{
                                        border: "1px solid red",
                                        borderColor: item === 'Past bookings' ? '#FAF9F6' : '#2F2F2F',
                                    }}
                                >
                                    {item}
                                </button>
